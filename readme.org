	...
	'(("n" "Agenda and all TODOs"
	  ...
	  ("hp" "Personal Agenda"
	   ((tags-todo "PRIORITY=\"A\"+personal" ((org-agenda-overriding-header "High Priority")))
	    ...
	    (tags-todo "personal+inbox|inbox" ((org-agenda-overriding-header "Inbox:")))
	  ...
	  ("hh" "Home Agenda"
	   ((tags-todo "PRIORITY=\"A\"+personal|PRIORITY=\"A\"+study" ((org-agenda-overriding-header "High Priority")))
	    ...
	    (tags-todo "personal+inbox|study+inbox|inbox" ((org-agenda-skip-function '(org-agenda-skip-entry-if 'scheduled))
